...
public class UserRepositoryTCLiveTest {
    ...
    private static final String USER_EMAIL2 = "user2@test.com";
    private static final String USER_EMAIL3 = "user3@test.com";
    private static final String USER_EMAIL4 = "user4@test.com";
